...
void DisplayArea::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DisplayArea *_t = static_cast<DisplayArea *>(_o);
        switch (_id) {
        ...
        {
            typedef void (DisplayArea::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DisplayArea::viewChanged)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject DisplayArea::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_DisplayArea.data,
      qt_meta_data_DisplayArea,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DisplayArea.stringdata))
        return static_cast<void*>(const_cast< DisplayArea*>(this));
